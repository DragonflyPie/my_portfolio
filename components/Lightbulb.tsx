...
const Lightbulb = () => {
  return (
    <div className="">
      <div className="group relative mt-4 flex min-w-[56px] scale-75 flex-col items-center justify-center hover:animate-blackout md:scale-100">
        ...
        <div className="-z-10 h-8 w-8 rounded-full border border-black transition-colors duration-300  dark:bg-yellow-400 dark:shadow-lightBult   ">
